...
class TaskClarification extends Base implements AuthenticatableContract,
                                    ...
                                    CanResetPasswordContract
{
     ...
     * @var string
     */
    public $table = 'stm_taskClarification';
    ...
    //protected $hidden = ['password', 'rememberLoginToken'];
	 ...
	 public function __construct() {
        ...
        // set fields
        //
        $this->__fields = array($this->primaryKey, 'postDesc', 'postType', 'postTypeSlug', 'fkProjectId', 'fkSegmentId', 'fkPhaseId', 'fkTaskId', 'fkBrandId', 'fkAddedById', 'isActive', 'addedAt', 'updatedAt', 'deletedAt');
    }
