...
class InvoiceSegment extends Base implements AuthenticatableContract,
                                    ...
                                    CanResetPasswordContract
{
     ...
     * @var string
     */
    public $table = 'stm_invoiceSegment';
    ...
    //protected $hidden = ['password', 'rememberLoginToken'];
	 ...
	 public function __construct() {
        ...
        // set fields
        //
        $this->__fields = array($this->primaryKey, 'fkInvoiceId', 'fkSegmentId', 'fkProjectId', 'fkClientId', 'segmentType', 'segmentAmount', 'segmentDescription', 'invoiceTotalAmount', 'invoicePaidAmount', 'invoiceDescription', 'invoiceStatus', 'isActive', 'addedAt', 'updatedAt', 'deletedAt');
    }
