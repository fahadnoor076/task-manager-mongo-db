...
class Brand extends Base implements AuthenticatableContract,
                                    ...
                                    CanResetPasswordContract
{
    ...
    protected $hidden = ['password', 'rememberLoginToken'];
	 ...
	 public function __construct() {
        ...
        // set fields
        //
        $this->__fields = array($this->primaryKey, 'brandName', 'brandSlug', 'brandUrl', 'startTime', 'endTIme', 'isActive', 'addedAt', 'updatedAt', 'deletedAt');
    }
