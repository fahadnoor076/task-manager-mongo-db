...
class Client extends Base implements AuthenticatableContract,
                                    ...
                                    CanResetPasswordContract
{
    ...
    //protected $hidden = ['password', 'rememberLoginToken'];
	 ...
	 public function __construct() {
        ...
        // set fields
        //
        $this->__fields = array($this->primaryKey, 'clientName', 'clientSlug', 'clientEmail', 'clientPhone', 'clientCompany', 'clientAddress', 'isActive', 'addedAt', 'updatedAt', 'deletedAt');
    }
     ...
     */
	 ...
	 function getRecordByEmail($email){
		...
		$db = MASTER_DB_NAME;
		$table = $this->__table;
		$search_array = array("clientEmail" => $email);
		$cursor = $mongo->$db->$table->find($search_array);
		$record = iterator_to_array($cursor);
		return $record;
	 }
