                        ...
                        <div class="bst-block">
                                    <div class="horizontal-form-style">
                                        ...
                                        <form name="roleForm" class="form-horizontal" method="post">
                                            <div class="form-group" id="error_userRoleName">
                                                <div class="row mrgn-all-none">
                                                    <label for="userRoleName" class="col-sm-2 control-label">Role Name</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="userRoleName" class="form-control" id="userRoleName" placeholder="Role Name" value="{!! $data[$id]['userRoleName']; !!}" />
                                                    </div>
                                                </div>
                                            </div>
