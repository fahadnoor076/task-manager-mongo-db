        ...
        <div class="bst-block">
          ...
          <div class="bst-block-content">
          	<ul class="nav nav-tabs mrgn-b-lg">
                <li class=""> <a href="{!! URL::to(config('/').'task/all-tasks/') !!}" aria-expanded="true">All Tasks </a>
                	<span class="badge badge-danger pos-absolute pos-abs-right-top alltasksCount" style="right:-6px; top:-6px;">{!! $alltasksCount !!}</span>
                </li>
                ...
                <li class="active"> <a href="{!! URL::to(config('/').'task/due-today-tasks/') !!}" aria-expanded="false">Tasks Due Today </a>
                	<span class="badge badge-danger pos-absolute pos-abs-right-top duetodaytasksCount" style="right:-6px; top:-6px;"></span>
                </li>
            ...
            <div class="tab-content">
                ...
                <div id="tab-3" class="tab-pane active fade in">
...
$(document).ready(function() {
	...
	var dg = $("#mydatatable").DataTable({
		...
		ajax: {
			url: "../{!! $module !!}/duetodaytasks-ajax/listing?_token=<?php echo csrf_token(); ?>", // ajax source
			type: "POST",
			data : function(d) {
		...
		drawCallback: function (settings) {
			$('.duetodaytasksCount').html(settings._iRecordsTotal);
			// other functionality
