        ...
        <div class="bst-block">
          ...
          <div class="bst-block-content">
          	<ul class="nav nav-tabs mrgn-b-lg">
                ...
                <li class="active"> <a href="{!! URL::to(config('/').'task/overdue-tasks/') !!}" aria-expanded="false">Tasks Overdue </a>
                	<span class="badge badge-danger pos-absolute pos-abs-right-top overduetasksCount" style="right:-6px; top:-6px;"></span>
                </li>
            </ul>
            <div class="tab-content">
                ...
                <div id="tab-5" class="tab-pane active fade in">
...
$(document).ready(function() {
	...
	var dg = $("#mydatatable").DataTable({
		...
		ajax: {
			url: "../{!! $module !!}/overduetasks-ajax/listing?_token=<?php echo csrf_token(); ?>", // ajax source
			type: "POST",
			data : function(d) {
		...
		drawCallback: function (settings) {
			$('.overduetasksCount').html(settings._iRecordsTotal);
			// other functionality
