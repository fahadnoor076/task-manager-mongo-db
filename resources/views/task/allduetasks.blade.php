        ...
        <div class="bst-block">
          ...
          <div class="bst-block-content">
          	<ul class="nav nav-tabs mrgn-b-lg">
                ...
                <li class="active"> <a href="{!! URL::to(config('/').'task/all-due-tasks/') !!}" aria-expanded="false">All Due Tasks </a>
                	<span class="badge badge-danger pos-absolute pos-abs-right-top allduetasksCount" style="right:-6px; top:-6px;"></span>
                </li>
            ...
            <div class="tab-content">
                ...
                <div id="tab-2" class="tab-pane active fade in">
...
$(document).ready(function() {
	...
	var dg = $("#mydatatable").DataTable({
		...
		ajax: {
			url: "../{!! $module !!}/allduetasks-ajax/listing?_token=<?php echo csrf_token(); ?>", // ajax source
			type: "POST",
			data : function(d) {
		...
		drawCallback: function (settings) {
			$('.allduetasksCount').html(settings._iRecordsTotal);
			// other functionality
