        ...
        <div class="bst-block">
          ...
          <div class="bst-block-content">
          	<ul class="nav nav-tabs mrgn-b-lg">
                ...
                <li class="active"> <a href="{!! URL::to(config('/').'task/clarification-tasks/') !!}" aria-expanded="false">Clarifications </a>
                	<span class="badge badge-danger pos-absolute pos-abs-right-top clarificationtasksCount" style="right:-6px; top:-6px;"></span>
                </li>
            ...
            <div class="tab-content">
                ...
                <div id="tab-4" class="tab-pane active fade in">
...
$(document).ready(function() {
	...
	var dg = $("#mydatatable").DataTable({
		...
		drawCallback: function (settings) {
			$('.clarificationtasksCount').html(settings._iRecordsTotal);
			// other functionality
