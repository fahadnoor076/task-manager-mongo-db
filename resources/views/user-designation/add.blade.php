                                          ...
                                          @if(sizeof($raw_child_ids) > 0) {{--*/ $j=0 /*--}} 
                                              ...
                                              <tr>
                                                ...
                                                <td class="hidden-xs" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                                                    <input type="checkbox" id="view_{!! $c_record[$raw_child_id['_id']->{'$id'}]['_id']->{'$id'} !!}" name="view_{!! $c_record[$raw_child_id['_id']->{'$id'}]['_id']->{'$id'} !!}">
                                                    <span></span> </label></td>
                                                <td class="text-center" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                                                    <input type="checkbox" id="add_{!! $c_record[$raw_child_id['_id']->{'$id'}]['_id']->{'$id'} !!}" name="add_{!! $c_record[$raw_child_id['_id']->{'$id'}]['_id']->{'$id'} !!}">
                                                    <span></span> </label></td>
                                                <td class="text-center" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                                                    <input type="checkbox" id="update_{!! $c_record[$raw_child_id['_id']->{'$id'}]['_id']->{'$id'} !!}" name="update_{!! $c_record[$raw_child_id['_id']->{'$id'}]['_id']->{'$id'} !!}">
                                                    <span></span> </label></td>
                                                <td class="text-center" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                                                    <input type="checkbox" id="delete_{!! $c_record[$raw_child_id['_id']->{'$id'}]['_id']->{'$id'} !!}" name="delete_{!! $c_record[$raw_child_id['_id']->{'$id'}]['_id']->{'$id'} !!}">
                                                    <span></span> </label></td>
                                              </tr>
                                              @endforeach
                                          	@else 
                                              ...
                                              <tr>
                                                <td class="text-center" style="width: 10%;"><strong>{!! $i !!}</strong>
                                                  <input type="hidden" name="modules[]" value="{!! $record[$raw_id['_id']->{'$id'}]['_id']->{'$id'} !!}" /><input type="hidden" name="parents[]" value="{!! $record[$raw_id['_id']->{'$id'}]['parentId'] !!}" /></td>
                                                <td style="width: 50%;"><strong>{!! $record[$raw_id['_id']->{'$id'}]['userModuleName'] !!}</strong></td>
                                                <td class="hidden-xs" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                                                    <input type="checkbox" id="view_{!! $record[$raw_id['_id']->{'$id'}]['_id']->{'$id'} !!}" name="view_{!! $record[$raw_id['_id']->{'$id'}]['_id']->{'$id'} !!}">
                                                    <span></span> </label></td>
                                                <td class="text-center" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                                                    <input type="checkbox" id="add_{!! $record[$raw_id['_id']->{'$id'}]['_id']->{'$id'} !!}" name="add_{!! $record[$raw_id['_id']->{'$id'}]['_id']->{'$id'} !!}">
                                                    <span></span> </label></td>
                                                <td class="text-center" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                                                    <input type="checkbox" id="update_{!! $record[$raw_id['_id']->{'$id'}]['_id']->{'$id'} !!}" name="update_{!! $record[$raw_id['_id']->{'$id'}]['_id']->{'$id'} !!}">
                                                    <span></span> </label></td>
                                                <td class="text-center" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                                                    <input type="checkbox" id="delete_{!! $record[$raw_id['_id']->{'$id'}]['_id']->{'$id'} !!}" name="delete_{!! $record[$raw_id['_id']->{'$id'}]['_id']->{'$id'} !!}">
                                                    <span></span> </label></td>
                                              </tr>
                                          	@endif
                                          @endforeach
                                      	...
                                      	@if(!empty($prev_ids))
                                        	...
                                        	@foreach($prev_ids as $key => $privilege)
                                            	...
                                            	<tr>
                                                    ...
                                                    <td class="hidden-xs" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                                                        <input type="checkbox" id="permission_{!! $key !!}" name="permission_{!! $key !!}">
                                                        <span></span> </label></td>
                                                </tr>
                                            @endforeach
                                        @endif
