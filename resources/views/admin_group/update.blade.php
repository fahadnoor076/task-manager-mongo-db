                ...
                <div class="tab-pane fade fade-up active in" id="tab-step1">
                  <div class="form-group">
                    <div class="col-sm-8 col-sm-offset-2">
                      ...
                      @if ($data->{$pk} == 1)
                        <input class="form-control" disabled="disabled" type="text" id="name" name="name" value="{!! $data->name !!}" placeholder="Enter Group Name">
                        ...
                        @else
                        <input class="form-control" type="text" id="name" name="name" value="{!! $data->name !!}" placeholder="Enter Group Name">
                ...
                <div class="tab-pane fade fade-up" id="tab-step2">
                  <div class="block-content">
                    <table class="table table-bordered">
                      ...
                      <!-- check permissions -->
                      {{--*/ $view_checked = $admin_module_permission_model->checkAccess($c_record->class_name, "view", $data->{$pk}) ? 'checked="checked"' : "" /*--}}
                      {{--*/ $add_checked = $admin_module_permission_model->checkAccess($c_record->class_name, "add", $data->{$pk}) ? 'checked="checked"' : "" /*--}}
                      {{--*/ $update_checked = $admin_module_permission_model->checkAccess($c_record->class_name, "update", $data->{$pk}) ? 'checked="checked"' : "" /*--}}
                      {{--*/ $delete_checked = $admin_module_permission_model->checkAccess($c_record->class_name, "delete", $data->{$pk}) ? 'checked="checked"' : "" /*--}}
                      ...
                      <tr>
                        ...
                        <td class="hidden-xs" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                            <input type="checkbox" id="view_{!! $c_record->admin_module_id !!}" name="view_{!! $c_record->admin_module_id !!}" {!! $view_checked !!} >
                            <span></span> </label></td>
                        <td class="text-center" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                            <input type="checkbox" id="add_{!! $c_record->admin_module_id !!}" name="add_{!! $c_record->admin_module_id !!}" {!! $add_checked !!} >
                            <span></span> </label></td>
                        <td class="text-center" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                            <input type="checkbox" id="update_{!! $c_record->admin_module_id !!}" name="update_{!! $c_record->admin_module_id !!}" {!! $update_checked !!} >
                            <span></span> </label></td>
                        <td class="text-center" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                            <input type="checkbox" id="delete_{!! $c_record->admin_module_id !!}" name="delete_{!! $c_record->admin_module_id !!}" {!! $delete_checked !!} >
                            <span></span> </label></td>
                      </tr>
                      @endforeach
                      @else 
                      <!-- check permissions -->
                      {{--*/ $view_checked = $admin_module_permission_model->checkAccess($record->class_name, "view", $data->{$pk}) ? 'checked="checked"' : "" /*--}}
                      {{--*/ $add_checked = $admin_module_permission_model->checkAccess($record->class_name, "add", $data->{$pk}) ? 'checked="checked"' : "" /*--}}
                      {{--*/ $update_checked = $admin_module_permission_model->checkAccess($record->class_name, "update", $data->{$pk}) ? 'checked="checked"' : "" /*--}}
                      {{--*/ $delete_checked = $admin_module_permission_model->checkAccess($record->class_name, "delete", $data->{$pk}) ? 'checked="checked"' : "" /*--}}
                      <!-- no child -->
                      <tr>
                        ...
                        <td class="hidden-xs" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                            <input type="checkbox" id="view_{!! $record->admin_module_id !!}" name="view_{!! $record->admin_module_id !!}" {!! $view_checked !!} >
                            <span></span> </label></td>
                        <td class="text-center" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                            <input type="checkbox" id="add_{!! $record->admin_module_id !!}" name="add_{!! $record->admin_module_id !!}" {!! $add_checked !!} >
                            <span></span> </label></td>
                        <td class="text-center" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                            <input type="checkbox" id="update_{!! $record->admin_module_id !!}" name="update_{!! $record->admin_module_id !!}" {!! $update_checked !!} >
                            <span></span> </label></td>
                        <td class="text-center" style="width: 10%;"><label class="css-input css-checkbox css-checkbox-rounded css-checkbox-sm css-checkbox-primary">
                            <input type="checkbox" id="delete_{!! $record->admin_module_id !!}" name="delete_{!! $record->admin_module_id !!}" {!! $delete_checked !!} >
                            <span></span> </label></td>
                      </tr>
                      @endif
                      @endforeach
