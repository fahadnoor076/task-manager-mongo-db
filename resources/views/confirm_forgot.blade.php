    ...
    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4"> 
      ...
      <div class="block block-themed animated fadeIn">
        ...
        <div class="block-content block-content-full block-content-narrow"> 
          <!-- Reminder Title -->
          <h1 class="h2 font-w600 push-30-t push-15 text-center"><img src="{!! URL::to(config('constants.ADMIN_IMG_URL').'beast-logo.png') !!}" class="logo-custom" alt="-"></h1>
          @if($record === FALSE)
          <p class="text-danger text-center">Invalid reset password link provided</p>
          @elseif($record['isActive'] <> 1)
          <p class="text-danger text-center">Sorry, your account is either inactive or baned by Administrator</p>
          @else
            ...
            <div class="form-group">
              <div class="col-xs-12">
                <div class="form-material form-material-primary floating">
                  ...
                  <label for="code"><span class="text-danger">*</span> Confirmation Code</label>
                  <div id="error_msg_code" class="help-block text-right animated fadeInDown hide" style="color:red"></div>
                </div>
              </div>
            </div>
            <div class="form-group">
