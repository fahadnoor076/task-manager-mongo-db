                        ...
                        <div class="bst-block">
                                    <div class="horizontal-form-style">
                                        ...
                                        <form name="roleForm" class="form-horizontal" method="post">
                                            <div class="form-group" id="error_departmentName">
                                                <div class="row mrgn-all-none">
                                                    <label for="departmentName" class="col-sm-2 control-label">Department Name</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="departmentName" class="form-control" id="departmentName" placeholder="Department Name" value="{!! $data[$id]['departmentName']; !!}" />
                                                    </div>
                                                </div>
                                            </div>
