                                            ...
                                            <table class="display responsive nowrap js-table-sections table table-hover js-dataTable-full" id="mydatatable" width="100%">
                                              ...
                                              <tfoot style="display: table-header-group;">
                                                <tr>
                                                  ...
                                                  <th class="text-center"></th>
                                                  <th><input type="text" name="userModuleName" class="search_keyword" /></th>
                                                  <th><input type="text" name="iconClass" class="search_keyword" /></th>
                                                  <th><select name="showInMenu" class="form-control search_keyword">
                                                  		<option value="">::Select Value::</option>
                                                        <option value="1">Yes</option>
                                                        <option value="0">No</option>
                                                      </select></th>
                                                  <th><input type="text" name="orderId" class="search_keyword" /></th>
