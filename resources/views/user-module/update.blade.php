                                        ...
                                        <form name="roleForm" class="form-horizontal" method="post">
                                            <div class="form-group" id="error_userModuleName">
                                                <div class="row mrgn-all-none">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="userModuleName" class="form-control" id="userModuleName" placeholder="Module Name" value="{!! $data[$id]['userModuleName']; !!}" />
                                                    </div>
                                                </div>
                                            </div>
                                            	...
                                            	<div class="row mrgn-all-none">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select class="form-control" id="parentId" name="parentId">
                                                            ...
                                                            <option value="0" {!! $data[$id]['parentId'] == '0' ? 'selected="selected"' : '' !!}>::No Parent::</option>
                                                            @if(!empty($parentModules))
                                                            	@foreach($parentModules as $key => $module)
                                                                	{{--*/ $sel = $data[$id]['parentId'] == $key ? 'selected="selected"' : '' /*--}}
                                                                	<option value="{!! $key !!}" {!! $sel !!}>{!! $module['userModuleName'] !!}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="form-group" id="error_iconClass">
                                                <div class="row mrgn-all-none">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    	<input type="text" name="iconClass" class="form-control" id="iconClass" placeholder="Icon Class" value="{!! $data[$id]['iconClass']; !!}" />
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row mrgn-all-none">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select class="form-control" id="showInMenu" name="showInMenu">
                                                            ...
                                                            <option value="1" {!! $data[$id]['showInMenu'] == '1' ? 'selected="selected"' : '' !!}>Yes</option>
                                                            <option value="0" {!! $data[$id]['showInMenu'] == '0' ? 'selected="selected"' : '' !!}>No</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group" id="error_orderId">
                                                <div class="row mrgn-all-none">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="number" step="0.01" min="1" name="orderId" class="form-control" id="orderId" placeholder="Navigation Order" value="{!! $data[$id]['orderId']; !!}" />
                                                    </div>
                                                </div>
                                            </div>
