                    ...
                    <div class="bst-content">
                        <div class="bst-page-bar mrgn-b-md breadcrumb-double-arrow">
                            ...
                            <div class="text-right">
                            	<a href="{!! URL::to(DIR_ADMIN.$module.'/add') !!}" class="btn btn-primary">+ Add {!! $p_title !!}</a>
                            </div>
                            @endif
                        </div>
                        <!-- Session Messages --> 
                                            ...
                                            <table class="display responsive nowrap js-table-sections table table-hover js-dataTable-full" id="mydatatable" width="100%">
                                              ...
                                              <tfoot style="display: table-header-group;">
                                                <tr>
                                                  ...
                                                  <th><input type="text" name="clientName" class="search_keyword" /></th>
                                                  <th><input type="text" name="clientEmail" class="search_keyword" /></th>
                                                  <th><input type="text" name="clientPhone" class="search_keyword" /></th>
                                                  <th><input type="text" name="clientCompany" class="search_keyword" /></th>
                                                  <th></th>
                                                  <th></th>
