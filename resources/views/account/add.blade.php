                                        ...
                                        <form name="roleForm" class="form-horizontal" method="post">
                                            <div class="form-group" id="error_clientName">
                                                <div class="row mrgn-all-none">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="clientName" class="form-control" id="branclientNamedName" placeholder="Client Name" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group" id="error_clientEmail">
                                                <div class="row mrgn-all-none">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="clientEmail" class="form-control" id="clientEmail" placeholder="Client Email" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group" id="error_clientPhone">
                                                <div class="row mrgn-all-none">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="clientPhone" class="form-control" id="clientPhone" placeholder="Client Phone" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group" id="error_clientCompany">
                                                <div class="row mrgn-all-none">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="clientCompany" class="form-control" id="clientCompany" placeholder="Client Company" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group" id="error_clientAddress">
                                                <div class="row mrgn-all-none">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="clientAddress" class="form-control" id="clientAddress" placeholder="Client Address" />
                                                    </div>
                                                </div>
                                            </div>
