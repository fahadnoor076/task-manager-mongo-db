                    ...
                    <div class="bst-content">
                        ...
                        <div class="bst-block">
                            <div class="bst-block-title mrgn-b-lg">
                                <h3 class="text-capitalize">{!! $p_title !!}</h3> </div>
                                            ...
                                            <table class="display responsive nowrap js-table-sections table table-hover js-dataTable-full" id="mydatatable" width="100%">
                                              ...
                                              <tfoot style="display: table-header-group;">
                                                <tr>
                                                  ...
                                                  <th><select name="departmentId" class="form-control">
                                                  ...
                                                  <th><input type="text" name="phaseName" class="search_keyword" /></th>
                                                  <th><select name="isActive" class="form-control">
