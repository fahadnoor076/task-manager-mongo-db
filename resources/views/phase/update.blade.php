                    ...
                    <div class="bst-content">
                        ...
                        <div class="bst-block">
                                    <div class="horizontal-form-style">
                                        ...
                                        <form name="phaseForm" class="form-horizontal" method="post">
                                        	<div class="form-group" id="error_departmentId">
                                                        ...
                                                        <select name="departmentId" class="form-control" id="departmentId">
                                                            ...
                                                            @if($departments > 0)
                                                            	@foreach($departments as $key => $department)
                                                                	@if($department['departmentSlug'] != 'sales')
                                            ...
                                            <div class="form-group" id="error_phaseName">
                                                <div class="row mrgn-all-none">
                                                    <label for="phaseName" class="col-sm-2 control-label">Phase Name</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="phaseName" class="form-control" id="phaseName" placeholder="Phase Name" value="{!! $data[$id]['phaseName']; !!}" />
                                                    </div>
                                                </div>
                                            </div>
...
$(function() {
	...
	$('form[name="phaseForm"]').submit(function(e) {
		e.preventDefault();
