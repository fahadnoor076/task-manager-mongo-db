                    ...
                    <div class="bst-content">
                        <div class="bst-page-bar mrgn-b-md breadcrumb-double-arrow">
                            ...
                            <div class="text-right">
                            	<a href="{!! URL::to(DIR_ADMIN.$module.'/add') !!}" class="btn btn-primary">+ Add User</a>
                            </div>
                            @endif
                        </div>
                        <!-- Session Messages --> 
                        ...
                        <div class="bst-block">
                            <div class="bst-block-title mrgn-b-lg">
                                <h3 class="text-capitalize">Users</h3> </div>
                                            ...
                                            <table class="display responsive nowrap js-table-sections table table-hover js-dataTable-full" id="mydatatable" width="100%">
                                              ...
                                              <tfoot style="display: table-header-group;">
                                                <tr>
                                                  ...
                                                  <th><input type="text" name="userEmail" /></th>
                                                  <th><input type="text" name="userContactPersonal" /></th>
                                                  <th><select class="form-control" name="fkRoleId">
                                                  ...
                                                  <th><select class="form-control" name="fkDesignationId">
