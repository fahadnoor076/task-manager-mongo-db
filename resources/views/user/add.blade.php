                                        ...
                                        <form name="dataForm" class="form-horizontal" method="post">
                                            ...
                                            <div class="form-group" id="error_userPassword">
                                                <div class="row mrgn-all-none">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" class="form-control" id="userPassword" name="userPassword" value="salsoft{!! date('Y'); !!}" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group" id="error_userContactPersonal">
                                                <div class="row mrgn-all-none">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="tel" class="form-control" id="userContactPersonal inputTel" name="userContactPersonal" placeholder="0345-1234567" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group" id="error_userContactEmergency">
                                                <div class="row mrgn-all-none">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="tel"  class="form-control" id="userContactEmergency inputTel" name="userContactEmergency" placeholder="0333-1234567" />
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <select class="form-control" id="fkDesignationId" name="fkDesignationId">
                                                            ...
                                                            @if($designations > 0)
                                                            	@foreach($designations as $key => $designation)
                                                                	<option value="{!! $key !!}">{!! $designation['userDesignationName'] !!}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    </div>
                                            ...
                                            <input type="hidden" name="designation_slug" class="designation_slug" value="" />
