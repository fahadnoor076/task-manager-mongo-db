                                            ...
                                            <div class="form-group" id="error_teamName">
                                                <div class="row mrgn-all-none">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="teamName" class="form-control" id="teamName" placeholder="Team Name" value="{!! $data[$id]['teamName']; !!}" />
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    	<select class="form-control" id="fkDepartmentId" name="fkDepartmentId">
                                                            ...
                                                            @if($departments > 0)
                                                                ...
                                                                {!! $sel = ($data[$id]['fkDepartmentId']->{'$id'} == $key) ? 'selected="selected"' : '' !!}
