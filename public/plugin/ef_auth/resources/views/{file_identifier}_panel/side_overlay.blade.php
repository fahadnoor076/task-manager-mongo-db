...
<aside id="side-overlay"> 
  ...
  <div id="side-overlay-scroll"> 
    ...
    <div class="side-header side-content"> 
      ...
      <button class="btn btn-default pull-right" type="button" data-toggle="layout" data-action="sidebar_toggle"> <i class="fa fa-times"></i> </button>
      <span> <img class="img-avatar img-avatar32" src="{!! URL::to(config('constants.ADMIN_IMG_URL').'/avatars/avatar10.jpg') !!}" alt=""> <span class="font-w600 push-10-l">Roger Hart</span> </span> </div>
    <!-- END Side Header --> 
    ...
    <div class="side-content remove-padding-t"> 
      ...
      <!--                <div class="block pull-r-l">
                    ...
                    <div class="block-content">
                         Quick Settings Form 
                        <form class="form-bordered" action="javascript:;" method="post" onsubmit="return false;">
