...
<main id="main-container"> 
  ...
  <div class="content"> 
    ...
    <div class="row" id="tiles_wrapper"> 
      ...
      <div class="col-lg-4" id="widget_{!! $raw_widget->{wildcard_identifier}_widget_id !!}"><i class="fa fa-2x fa-asterisk fa-spin text-success pull-right"></i></div>
      <!--<div class="col-lg-4" id="widget_{!! $raw_widget->{wildcard_identifier}_widget_id !!}"><div>--> 
      @endforeach
      @endif
      ...
      <div class="col-lg-6" id="widget_{!! $raw_widget->{wildcard_identifier}_widget_id !!}"><i class="fa fa-2x fa-asterisk fa-spin text-success pull-right"></i></div>
      <!--<div class="col-lg-4" id="widget_{!! $raw_widget->{wildcard_identifier}_widget_id !!}"><div>--> 
      @endforeach
      @endif
...
$(function() {
	<?php if(isset($widget["all"][0])):  ?>
		<?php foreach($widget["all"] as $raw_widget): ?>
			<?php $widget = $admin_widget_model->get($raw_widget->{wildcard_identifier}_widget_id); ?>
			jsonValidate('<?php echo config('pl_{wildcard_identifier}.DIR_PANEL'); ?>parse_widget/<?php echo $widget->type; ?>/<?php echo $widget->identifier; ?>?_token=<?php echo csrf_token(); ?>');
        <?php endforeach; ?>
    <?php endif; ?>
});
</script> 
