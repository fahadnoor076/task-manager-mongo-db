...
<div class="content overflow-hidden">
  <div class="row">
    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4"> 
      ...
      @if(in_array('login', $plugin_features))       
      <!-- Session Messages --> 
      @include(config('pl_{wildcard_identifier}.DIR_PANEL').'flash_message')
      <div class="block block-themed animated fadeIn">
        <div class="block-header bg-success">
         @if(in_array('forgot_password', $plugin_features))
          <ul class="block-options">
            <li> <a href="{!! URL::to(config('pl_{wildcard_identifier}.DIR_PANEL').'forgot_password') !!}">Forgot Password?</a> </li>
            <!--                        <li>
        ...
        <div class="block-content block-content-full block-content-narrow"> 
          ...
          <form name="data_form" class="js-validation-login form-horizontal push-30-t push-50" action="" method="post">
            ...
            <div class="form-group">
             ...
             @if(in_array('remember_login', $plugin_features))
            <div class="form-group">
              <div class="col-xs-12">
      ...
      <!-- END Login Block -->
      @else
      <div>This feature is inactive</div>
      @enif
    </div>
  </div>
</div>
