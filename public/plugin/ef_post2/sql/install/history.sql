...
INSERT INTO `history`(`identifier`,`created_at`) values ('{wildcard_identifier}_{target_identifier}-save_attachment','{wildcard_datetime}') ON DUPLICATE KEY UPDATE updated_at = '{wildcard_datetime}';
INSERT INTO `history`(`identifier`,`created_at`) values ('{wildcard_identifier}_{target_identifier}-add_post','{wildcard_datetime}') ON DUPLICATE KEY UPDATE updated_at = '{wildcard_datetime}';
