...
('social/{wildcard_identifier}/{target_identifier}/like/post','required','int','actor_id','Actor id for liking',1,2001.1,'{wildcard_datetime}',NULL,NULL),
('social/{wildcard_identifier}/{target_identifier}/like/post','required','text','actor_type','Actor type for liking',1,2001.2,'{wildcard_datetime}',NULL,NULL),
('social/{wildcard_identifier}/{target_identifier}/like/post','required','int','target_id','Target id for liking',1,2001.3,'{wildcard_datetime}',NULL,NULL),
('social/{wildcard_identifier}/{target_identifier}/comment/add','required','int','actor_id','Actor id for commenting',1,2002.1,'{wildcard_datetime}',NULL,NULL),
('social/{wildcard_identifier}/{target_identifier}/comment/add','required','text','actor_type','Actor type for commenting',1,2002.2,'{wildcard_datetime}',NULL,NULL),
('social/{wildcard_identifier}/{target_identifier}/comment/add','required','int','target_id','Target id for commenting',1,2002.3,'{wildcard_datetime}',NULL,NULL),
...
('social/{wildcard_identifier}/{target_identifier}/comment/edit','required','int','actor_id','Actor id for Edit Comment',1,2003.2,'{wildcard_datetime}',NULL,NULL),
('social/{wildcard_identifier}/{target_identifier}/comment/edit','required','text','actor_type','Actor type for editing comment',1,2003.3,'{wildcard_datetime}',NULL,NULL),
('social/{wildcard_identifier}/{target_identifier}/comment/edit','required','int','target_id','Target id for editing comment',1,2003.4,'{wildcard_datetime}',NULL,NULL),
...
('social/{wildcard_identifier}/{target_identifier}/review/add','required','int','actor_id','Actor id for adding review',1,2004.1,'{wildcard_datetime}',NULL,NULL),
('social/{wildcard_identifier}/{target_identifier}/review/add','required','text','actor_type','Actor type for adding review',1,2004.2,'{wildcard_datetime}',NULL,NULL),
('social/{wildcard_identifier}/{target_identifier}/review/add','required','int','target_id','Target id for adding review',1,2004.3,'{wildcard_datetime}',NULL,NULL),
...
('social/{wildcard_identifier}/{target_identifier}/review/edit','required','int','actor_id','Actor id for editing review',1,2005.2,'{wildcard_datetime}',NULL,NULL),
('social/{wildcard_identifier}/{target_identifier}/review/edit','required','text','actor_type','Actor type for editing review',1,2005.3,'{wildcard_datetime}',NULL,NULL),
('social/{wildcard_identifier}/{target_identifier}/review/edit','required','int','target_id','Target id for editing review',1,2005.4,'{wildcard_datetime}',NULL,NULL),
...
('social/{wildcard_identifier}/{target_identifier}/follow','required','int','actor_id','Actor id for following',1,2006.1,'{wildcard_datetime}',NULL,NULL),
('social/{wildcard_identifier}/{target_identifier}/follow','required','int','target_id','Target id for following',1,2006.2,'{wildcard_datetime}',NULL,NULL),
('social/{wildcard_identifier}/{target_identifier}/unfollow','required','int','actor_id','Follow id for unfollowing',1,2007.1,'{wildcard_datetime}',NULL,NULL),
('social/{wildcard_identifier}/{target_identifier}/unfollow','required','int','actor_id','Follow id for unfollowing',1,2007.2,'{wildcard_datetime}',NULL,NULL);
